...
We follow a similar protocol in our [LOVEU-TGVE-2023 dataset](). Our dataset consists of 76 videos. Each video has 4 editing prompts. 
...
Download the [loveu-tgve-2023.zip](), and unpack it to the `data` folder. 
